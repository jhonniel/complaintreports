const SENSITIVE_KEY =
  /phone|email|full_name|first_name|last_name|fullname|address|birth_date|password|authorization|access_token|refresh_token|service_role|apikey|api_key|secret|spaces_key|user_agent|session_id|latitude|longitude|ip_address|\bip\b|forwarded/i
