const SENSITIVE_KEY =
  /phone|email|full_name|fullname|address|birth_date|password|authorization|access_token|refresh_token|service_role|apikey|api_key|user_agent|session_id|latitude|longitude/i
